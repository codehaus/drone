...
public class com_mysql_jdbc_Driver extends DatabaseLogs
{
	...
	protected void initializeQueries()
	{
		...
		{
			sCreateGetLogMessagesIndex = "CREATE INDEX TRIGGER log_getlog_idx ON "+sCreateTableLog.getTable()+" (botname, channel, servername, moment)";
		}
		...
		{
			sDropGetLogMessagesIndex = "DROP INDEX TRIGGER log_getlog_idx";
		}
	}
