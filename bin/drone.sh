...
cd $JETTY_HOME
java -classpath "$JETTY_HOME/lib/javax.servlet.jar:$JETTY_HOME/lib/org.mortbay.jetty.jar:$PROGDIR/lib/mysql-connector-java-3.0.11-stable-bin.jar:$PROGDIR/lib/postgres-jdbc-7.4.jar:$PROGDIR/lib/rife-0.7.2.jar:$PROGDIR/build/dist/drone-1.0.jar" -Djetty.home="$JETTY_HOME" -Drife.webapp.path=../src:../build/dist:../lib org.mortbay.jetty.Server "$JETTY_HOME/etc/jetty.xml"
